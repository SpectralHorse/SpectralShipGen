...
namespace SpectralShipGen
{
    ...
    ResolvedSurfaceDetailProfile DetailGenerator::resolveSurfaceDetailProfile(const ExplicitShipGenerationConfiguration& settings, const ShipGenerationProfile& styleProfile, const ShipFactionSurfaceDetailProfile& factionProfile) const
    {
