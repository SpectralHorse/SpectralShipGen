...
namespace PixelShipGenerator
{
    ...
    private:
        ...
        ResolvedSurfaceDetailProfile resolveSurfaceDetailProfile(const ExplicitShipGenerationConfiguration& settings, const ShipGenerationProfile& styleProfile, const ShipFactionSurfaceDetailProfile& factionProfile) const;
