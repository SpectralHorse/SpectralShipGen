...
namespace SpectralShipGenDiagnostics
{
    ...
    struct GenerationStatistics
    {
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipMaterialZoneType::SHIP_MATERIAL_ZONE_TYPE_END)> MaterialZoneTypeCounts = {};
        NumericStatistics LiveryMarkingCount;
        NumericStatistics LiveryPrimaryPixelCount;
        NumericStatistics LiverySecondaryPixelCount;
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipLiveryType::SHIP_LIVERY_TYPE_END)> LiveryTypeCounts = {};
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipDetailMotifType::SHIP_DETAIL_MOTIF_TYPE_END)> PrimaryDetailMotifCounts = {};
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipDetailMotifType::SHIP_DETAIL_MOTIF_TYPE_END)> SecondaryDetailMotifCounts = {};
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipStructuralNegativeSpaceType::SHIP_STRUCTURAL_NEGATIVE_SPACE_TYPE_END)> StructuralNegativeSpaceTypeCounts = {};
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::SilhouetteValidationFailureReason::SILHOUETTE_VALIDATION_FAILURE_REASON_END)> SilhouetteValidationFailureCounts = {};
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::WingShapeType::WING_SHAPE_TYPE_END)> WingShapeCounts = {};
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipVisualAnchorType::SHIP_VISUAL_ANCHOR_TYPE_END)> PrimaryVisualAnchorCounts = {};
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipVisualAnchorType::SHIP_VISUAL_ANCHOR_TYPE_END)> SecondaryVisualAnchorCounts = {};
        std::map<std::string, uint64_t> VisualAnchorCombinationFrequencies;
        std::array<NumericStatistics, SpectralShipGen::GenerationComplexityBudget::CategoryCount> ComplexityCategoryAllocations;
        std::array<NumericStatistics, SpectralShipGen::GenerationComplexityBudget::CategoryCount> ComplexityCategoryConsumed;
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::MacroAsymmetryCategory::MACRO_ASYMMETRY_CATEGORY_END)> MacroAsymmetryCategoryCounts = {};
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::MacroAsymmetrySide::MACRO_ASYMMETRY_SIDE_END)> MacroAsymmetrySideCounts = {};
        std::array<NumericStatistics, SpectralShipGen::GenerationSpatialBudget::RegionCount> SpatialRegionLoadPercent;
        std::array<NumericStatistics, SpectralShipGen::GenerationSpatialBudget::RegionCount> SpatialRegionDominantCount;
        std::array<NumericStatistics, SpectralShipGen::GenerationSpatialBudget::RegionCount> SpatialRegionRejectionCount;
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipHullLayerType::SHIP_HULL_LAYER_TYPE_END)> HullLayerTypeCounts = {};
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipCoreTreatmentType::SHIP_CORE_TREATMENT_TYPE_END)> CoreTreatmentTypeCounts = {};
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::HullModifierType::HULL_MODIFIER_TYPE_END)> HullModifierOccurrenceCounts = {};
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::HullModifierType::HULL_MODIFIER_TYPE_END)> HullModifierAttemptCounts = {};
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::HullModifierType::HULL_MODIFIER_TYPE_END)> HullModifierRejectionCounts = {};
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::CockpitSizeClass::COCKPIT_SIZE_CLASS_END)> CockpitSizeCounts = {};
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::CockpitShapeType::COCKPIT_SHAPE_TYPE_END)> CockpitShapeCounts = {};
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipMajorFeatureType::SHIP_MAJOR_FEATURE_TYPE_END)> MajorFeatureTypeCounts = {};
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipWeaponType::SHIP_WEAPON_TYPE_END)> WeaponTypeCounts = {};
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipWeaponHardpointRegion::SHIP_WEAPON_HARDPOINT_REGION_END)> WeaponRegionCounts = {};
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::EngineLayoutType::ENGINE_LAYOUT_TYPE_END)> EngineLayoutCounts = {};
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::EngineSizeClass::ENGINE_SIZE_CLASS_END)> EngineSizeCounts = {};
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::ShipAttachmentType::SHIP_ATTACHMENT_TYPE_END)> AttachmentTypeCounts = {};
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::SupplementalSurfaceDetailType::SUPPLEMENTAL_SURFACE_DETAIL_TYPE_END)> SupplementalSurfaceDetailCounts = {};

        void recordSuccess(const SpectralShipGen::GeneratedShip& ship, const SpectralShipGen::ShipGenerationDebugInfo& debugInfo, const DiagnosticGenerationConfiguration& configuration);
        void recordFailure(const SpectralShipGen::ShipGenerationDebugInfo& debugInfo);
