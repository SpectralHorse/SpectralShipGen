...
namespace SpectralShipGenDiagnostics
{
    ...
    {
        std::vector<SpectralShipGen::ShipDimensions> Dimensions = { { 44u, 44u } };
        std::vector<SpectralShipGen::ShipStyle> Styles = { SpectralShipGen::ShipStyle::FIGHTER };
        std::vector<SpectralShipGen::ShipFactionType> Factions = { SpectralShipGen::ShipFactionType::FRONTIER };
    ...
    struct DiagnosticsProgress
    {
        ...
        SpectralShipGen::ShipGenerationPerformanceStage CurrentStage = SpectralShipGen::ShipGenerationPerformanceStage::SETUP_PLANNING;
    };
    ...
    struct DiagnosticsRawSampleResult
    {
        ...
        std::array<uint32_t, static_cast<std::size_t>(SpectralShipGen::SilhouetteValidationFailureReason::SILHOUETTE_VALIDATION_FAILURE_REASON_END)> SilhouetteRejectionCounts = {};
        ...
        SpectralShipGen::ShipVisualAnchorType PrimaryVisualAnchor = SpectralShipGen::ShipVisualAnchorType::SHIP_VISUAL_ANCHOR_TYPE_END;
        SpectralShipGen::ShipVisualAnchorType SecondaryVisualAnchor = SpectralShipGen::ShipVisualAnchorType::SHIP_VISUAL_ANCHOR_TYPE_END;
    ...
    struct DiagnosticsAggregateSummary
    {
        ...
        DiagnosticsDistributionSummary LiveryCoveragePercent;
        DiagnosticsDistributionSummary LiveryPrimaryCoveragePercent;
        DiagnosticsDistributionSummary LiverySecondaryCoveragePercent;
        DiagnosticsDistributionSummary LiveryLargestConnectedCoveragePercent;
        DiagnosticsDistributionSummary LiverySecondaryMaterialCoveragePercent;
        DiagnosticsDistributionSummary LiveryMechanicalMaterialCoveragePercent;
        uint64_t TotalLiveryCoverageRejections = 0u;
        uint64_t TotalLiveryMaterialPreservationRejections = 0u;
        ...
        std::array<DiagnosticsDistributionSummary, SpectralShipGen::ShipGenerationPerformanceStageCount> StageTimeMilliseconds;
        ...
        std::array<uint64_t, static_cast<std::size_t>(SpectralShipGen::SilhouetteValidationFailureReason::SILHOUETTE_VALIDATION_FAILURE_REASON_END)> SilhouetteRejectionCounts = {};
        ...
        SpectralShipGen::SilhouetteValidationFailureReason MostCommonSilhouetteRejection = SpectralShipGen::SilhouetteValidationFailureReason::NONE;
    };
