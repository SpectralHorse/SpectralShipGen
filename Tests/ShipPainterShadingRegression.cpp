...
namespace
{
    ...
    bool generatePipeline(PixelShipGenerator::ShipGenerationContext& context)
    {
        ...
        context.Ship.Palette = PixelShipGenerator::ShipPaletteGenerator::generate(context.Seeds.Palette, context.Settings.Style, context.Settings.Faction, context.Profile);
