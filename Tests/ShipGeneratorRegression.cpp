...
namespace
{
    ...
    { {
        ...
        { "fighter_xeno_96", 0xBF58476D1CE4E5B9ull, 96u, 96u, PixelShipGenerator::ShipStyle::FIGHTER, PixelShipGenerator::ShipFactionType::XENO, true, 0xF82FD132170F6CE6ull },
        { "sleek_ascendant_64", 0x8C3C010CB4754C91ull, 64u, 64u, PixelShipGenerator::ShipStyle::SLEEK, PixelShipGenerator::ShipFactionType::ASCENDANT, true, 0xB6788367EAC2F2FEull },
        { "sleek_military_96_no_attachments", 0x243F6A8885A308D3ull, 96u, 96u, PixelShipGenerator::ShipStyle::SLEEK, PixelShipGenerator::ShipFactionType::MILITARY, false, 0x928675D72ED331B4ull },
        { "heavy_military_64", 0xD1B54A32D192ED03ull, 64u, 64u, PixelShipGenerator::ShipStyle::HEAVY, PixelShipGenerator::ShipFactionType::MILITARY, true, 0x1DC27A45CC9F7F4Bull },
        { "heavy_ascendant_96", 0x13198A2E03707344ull, 96u, 96u, PixelShipGenerator::ShipStyle::HEAVY, PixelShipGenerator::ShipFactionType::ASCENDANT, true, 0x406E64F0112BDBB3ull },
        { "industrial_xeno_64_no_attachments", 0x94D049BB133111EBull, 64u, 64u, PixelShipGenerator::ShipStyle::INDUSTRIAL, PixelShipGenerator::ShipFactionType::XENO, false, 0x8605D713D192313Bull },
        ...
        { "fighter_military_96", 0xBB67AE8584CAA73Bull, 96u, 96u, PixelShipGenerator::ShipStyle::FIGHTER, PixelShipGenerator::ShipFactionType::MILITARY, false, 0xB1E6696EDE172E67ull },
        { "heavy_xeno_64", 0x3C6EF372FE94F82Bull, 64u, 64u, PixelShipGenerator::ShipStyle::HEAVY, PixelShipGenerator::ShipFactionType::XENO, true, 0x2AC76048FC67573Full },
        { "industrial_ascendant_96", 0xA54FF53A5F1D36F1ull, 96u, 96u, PixelShipGenerator::ShipStyle::INDUSTRIAL, PixelShipGenerator::ShipFactionType::ASCENDANT, true, 0x811F37DDC2868297ull }
    } };
